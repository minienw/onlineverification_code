...
@Component
class RsaOaepWithSha256AesCbcSchemeDecryptCommand
    (
    private val appSettings : IApplicationSettings,
    private val keyDecryptionCommand: RsaEcbOaepWithSha256DecryptCommand,
    private val payloadDecryptionCommand: AesCbcDecryptCommand,
)
{
    companion object{
        val Name: String = "RsaOaepWithSha256AesCbcScheme"
    }
    ...
    {
        val secretKeyParameter = keyDecryptionCommand.execute(secretKey, CryptoKeyConverter.decodeAsn1DerPkcs8Base64ToPrivateKey("RSA", appSettings.dccEncryptionRsaPrivateKey))
