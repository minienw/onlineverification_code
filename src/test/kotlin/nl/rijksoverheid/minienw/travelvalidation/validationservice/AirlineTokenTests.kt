...
public class AirlineTokenTests() {
    ...
    fun create() {
        ...
        `when`(appSettings.validationAccessTokenSignatureAlgorithms).thenReturn(arrayOf("RS256"))
        ...
        assert(body.sub == ttt.sub)
    }

    fun getAlg(alg:String) :String
    {
        if (alg.startsWith("ES", ignoreCase = true))
            return "EC"
        else
            return "RSA"
    }
    ...
    fun parseJws(jwk: PublicKeyJwk, vat:String)
    {
...
//Not valid - 4 errors in payload data
            Arguments.of(
                    PublicKeyJwk(
                        ...
                        alg="ES256",
                        use="sig" ),
                "eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCIsImtpZCI6IkFpZ29Ob2Q5cUlSeXFDWERRb0Z5ZWxNRE1vWGZ2RmRUUUtBUXFCUjRyZ0EifQ..7NSlOfYoEnQChoLBqNW9losOQtV7sTVjEnElXGP6lfzgDCdeszjtEZA0_BtfRW1XGVEulap1_hC1q9q1F1nuAg")
            )
    }
